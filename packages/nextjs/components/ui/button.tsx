  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        glass: "glass-card hover:bg-card/80 text-foreground border-primary/20 hover:border-primary/40",
        vote: "bg-secondary border-2 border-transparent hover:border-primary text-foreground font-semibold py-6 text-lg transition-all duration-300 hover:scale-[1.02]",
        voteActive: "bg-primary/20 border-2 border-primary text-primary font-semibold py-6 text-lg glow-primary",
      },
      size: {
