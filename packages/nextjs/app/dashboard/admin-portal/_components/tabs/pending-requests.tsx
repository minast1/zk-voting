...
const PendingRequests = () => {
  ...
  const {
    ...
    voterManagementList,
    approvalLogs,
  } = useVoterManagementLIst(poll_id ? BigInt(poll_id) : undefined);
  const pendingRequests = voterManagementList;
                    ...
                    <div className="flex items-center justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Requested {new Date(Math.floor(Number(request.timestamp))).toLocaleDateString()}
                        </p>
                      </div>
